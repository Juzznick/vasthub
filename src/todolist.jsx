   ...
   return (
      <div key={todo.id} className="todo">
         {(listID === "onGo" || listID === "drop") && (
            <div className="left">
               <i
                  className={`icon fas ${(listID === "onGo" && "fa-check tick") || (listID === "drop" && "fa-redo-alt retrieve")
                     }`}
         ...
         {(listID === "done" || listID === "onGo" || listID === "drop") && (
            <div className="right">
               <i
                  className={`icon fas ${(listID === "done" && "fa-trash-alt trash") ||
                     (listID === "onGo" && "fa-times close") ||
                     (listID === "drop" && "fa-trash-alt trash")
                     }`}
                  title={`${(listID === "done" && "Remove") ||
                     (listID === "onGo" && "Drop") ||
                     (listID === "drop" && "Remove")
                     }`}
                  onClick={() => {
...
function Todo() {
   ...
   return (
      <div className="app">
         ...
         {/* list section */}
         {/* list done */}
         <div className="status-lists-div">
